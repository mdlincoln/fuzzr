...
```{r}
fuzz_call(my_fuzz_results, fuzz_df[fuzz_df$n == "dbl_single", "results_index"])
fuzz_value(my_fuzz_results, fuzz_df[fuzz_df$n == "dbl_single", "results_index"])

fuzz_call(my_fuzz_results, fuzz_df[fuzz_df$n == "date_single", "results_index"])
# Hm, dates can be coerced into very large integers. Let's see how long this
# result is.
nchar(fuzz_value(my_fuzz_results, fuzz_df[fuzz_df$n == "date_single", "results_index"]))
# Oh dear.
```
